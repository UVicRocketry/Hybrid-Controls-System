...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.disableDesyncBox = QtWidgets.QCheckBox(Dialog)
        self.disableDesyncBox.setGeometry(QtCore.QRect(80, 70, 131, 20))
        self.disableDesyncBox.setObjectName("disableDesyncBox")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.disableDesyncBox.setText(_translate("Dialog", "Disable DeSync"))
